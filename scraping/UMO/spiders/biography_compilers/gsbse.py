...
OUTPUT_FILE = os.path.join(
    script_dir, "../../scrape_storage/biography_pages/gsbse.csv"
)
...
while True:
    ...
    faculty = soup.find_all(
        "div", class_="people-wrapper"
    )
    ...
    for tag in faculty:
        ...
        if fac_position and "Professor" in fac_position.text:
            ...
            for p_tag in tag.find_all("p", class_=lambda c: c is None):
                ...
                if a_tag and " bio" in a_tag.text.lower() or " biography" in a_tag.text.lower():
